...
const appSetting = {
  databaseURL: "https://sysufe-3e85d-default-rtdb.asia-southeast1.firebasedatabase.app/"
}
...
export default function Story() {
  ...
  function handleSubmit(e){
    ...
    // setContent(false)
    toast.success('Your story is successfully published');
      ...
      <div className='story-section'>
        ...
        <section className='section-2'>
          ...
          <div className='filter'>
            <h1 className='total-story'><span>{search.length === 1 ? `${stories} story` : search.length === 0 ? `No stories found` : `${stories} stories for you to read`}</span> </h1>
          </div>
